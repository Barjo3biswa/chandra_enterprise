...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				<h2>Edit Daily Service Report For <span class="font-underline col-teal">{{ date('d M, Y') }}</span></h2>
		...
		<div class="body">
			<form id="form_validation" method="POST" action="{{ route('update-dsr',Crypt::encrypt($dsr->id)) }}">
				{{ csrf_field() }}
				{!! method_field('PATCH') !!}
										...
										<div class="form-line">
											<select class="form-control" name="client_id" id="client_id" required>
												...
												<?php foreach ($clients as $client): ?>
													<option value="{{ $client->name }}" data-themeid="{{ $client->name }}" {{ (old('client_id', $dsr->client->name) == $client->name ? 'selected' : '') }}>{{ ucwords($client->name) }}</option>
												<?php endforeach; ?>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<select class="form-control show-tick" name="branch" id="branch" required>
											...
											<option value="{{ $cp->branch_name }}" data-themeid="{{ $cp->branch_name }}" {{ (old('branch', $dsr->client->branch_name) == $cp->branch_name) ? 'selected' : '' }}>{{ ucwords($cp->branch_name) }}</option>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<select class="form-control" name="maintenance_type" id="maintenance_type" required>
											...
											<option value="1" data-themeid="1" {{ old('maintenance_type', $dsr->maintenance_type) == "1" ? 'selected' : '' }} >Break Down</option>
											<option value="2" data-themeid="2" {{ old('maintenance_type', $dsr->maintenance_type) == "2" ? 'selected' : '' }}>Preventive</option>
										</select>
										...
										<tbody>
											...
											<tr>
												<th scope="row">
													...
													@if($dsr->contact_person_details == "1")
													{{ "checked" }}
													@endif required
													><label for="contact_person_1"></label>
												</th>
												<td>
													<input type="text" class="form-control" name="contact_person_name" value="{{ old('contact_person_name',(isset($dsr->contact_person_name) ? $dsr->contact_person_name  : "")) }}" placeholder="Contact person name" required>
												</td> 
												<td>
													<input type="text" class="form-control" name="c_p_1_ph_no" value="{{ old('c_p_1_ph_no',(isset($dsr->contact_person_ph_no) ? $dsr->contact_person_ph_no : "" )) }}" placeholder="Contact person phone no" maxlength="10">
												</td>
											</tr>
...
{{-- ################################ Break down ###################################################### --}}
					...
					@php $dsr_transaction1 = clone $dsr->dsr_transaction; @endphp
						...
						<div class="row" id="maintenance_type_detail_complaint">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<select class="form-control" name="complaint_id" id="complaint_id">
											...
											<?php foreach ($user_assigned_complaints1 as $user_assigned_complaint): ?>

												@if($user_assigned_complaint->id==old('complaint_id',$dsr->complaint_id))

												<option value="{{ $user_assigned_complaint->id }}" data-themeid="{{ $user_assigned_complaint->id }}" {{ old('complaint_id', $dsr->complaint_id) == "$user_assigned_complaint->id" ? 'selected' : '' }}>{{ ucwords($user_assigned_complaint->complaint_no) }}</option>
							...
							<div class="col-md-3">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control datepicker" name="call_receive_date" id="call_receive_date" value="{{ old('call_receive_date', date('d-m-Y', strtotime($dsr->call_receive_date))) }}" placeholder="Call receive date eg,(dd-mm-yyyy)" data-zdp_readonly_element="false">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<select class="form-control show-tick" name="complaint_status" id="complaint_status" required>
											...
											<option value="2" data-themeid='2' {{ (old('complaint_status',$dsr->complaint_status) == 2) ? 'selected' : '' }}>Complaint under-process</option>
											<option value="3" data-themeid='3' {{ (old('complaint_status',$dsr->complaint_status) == 3) ? 'selected' : '' }}> Complaint closed </option>
										</select>
							...
							<div class="col-md-4">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="nature_of_complaint_by_customer" id="nature_of_complaint_by_customer" value="{{ old('nature_of_complaint_by_customer',$dsr->nature_of_complaint_by_customer) }}">
							...
							<div class="col-md-4">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="fault_observation_by_engineer" id="fault_observation_by_engineer" value="{{ old('fault_observation_by_engineer',$dsr->fault_observation_by_engineer) }}">
							...
							<div class="col-md-4">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="action_taken_by_engineer" id="action_taken_by_engineer" value="{{ old('action_taken_by_engineer',$dsr->action_taken_by_engineer) }}">
							...
							<div class="col-md-12">
								<div class="form-group form-float">
									<div class="form-line">
										<textarea class="form-control" name="remarks" id="remarks">{{ old('remarks',$dsr->remarks) }}</textarea>
									...
									<div class="form-line">
										<select class="form-control" name="product_id" id="product_id" required>
											...
											@foreach ($assigned_products as $assigned_product)
								                    @if($assigned_product->product_id==old('product_id',$dsr->product_id))
								                    	<option value="{{ $assigned_product->product_id }}" {{ (old('product_id',$dsr->product_id) == $assigned_product->product_id) ? 'selected' : '' }}>{{ ucwords($assigned_product->product->name) }}</option>
								                    @endif
							                    @endforeach
							...
							<div class="col-md-4">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="model_no" id="model_no" value="{{ old('model_no',$dsr->model_no) }}">
							...
							<div class="col-md-4">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="serial_no" id="serial_no" value="{{ old('serial_no',$dsr->serial_no) }}">
										<label class="form-label">Product serial no</label>
									</div>
								</div>
							</div>

							<div class="col-md-12" id="spare_part_complaint_auto_hide">
								<table class="table table-bordered">
									...
									<tbody>
										...
										{{-- @if(isset($dsr->dsr_transaction[$i]))
										@php
											$value = $dsr->dsr_transaction[$i];
										@endphp --}}



										@if($dsr->dsr_transaction->count())

										@foreach($dsr->dsr_transaction as $key => $value)
											<tr>
											<td>{{ ($key+1) }}</td>
											<td>
												<div class="form-group form-float">
													<div class="form-line">
														<select class="form-control sp_check_duplicate spare_part_id" id="spare_part_id" name="spare_part_id[]" onchange="isDuplicateAlReadySelected(this)">
															...
															<option value="{{ $assigned_spare_part->spare_part->id }}" data-themeid="{{ $assigned_spare_part->spare_part->id }}" {{(old('spare_part_id', $value->spare_part_id) == $assigned_spare_part->spare_part->id ? 'selected' : '') }}>{{ ucwords($assigned_spare_part->spare_part->part_no) }}</option>
											...
											<td><input type="text" id="spare_part_description" name="spare_part_description[]" value="{{ old('spare_part_description',$value->spare_part->name) }}"></td>

											<td><input style="width: 35%;" type="text" id="spare_part_quantity" value="{{ old('spare_part_quantity', $value->spare_part_quantity) }}" name="spare_part_quantity[]"  oninput="checkQuantity(this)" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')"></td>
											<td>
												<input type="checkbox" id="basic_checkboxb_1{{ $i }}" name="spare_part_taken_back[]" value="1" onchange="checkOnluOne(this)" @if($value->spare_part_taken_back == 1) @php echo "checked" @endphp @endif>
												<label for="basic_checkboxb_1{{ $i }}">yes</label>

												<input type="checkbox" id="basic_checkboxb_2{{ $i }}" name="spare_part_taken_back[]" value="0" onchange="checkOnluOne(this)" @if($value->spare_part_taken_back == 2) @php echo "checked" @endphp @endif>
												<label for="basic_checkboxb_2{{ $i }}">no</label>

											</td>
											<td><input style="width: 35%;" type="text" value="{{ old('spare_part_taken_back_quantity', $value->spare_part_taken_back_quantity) }}" name="spare_part_taken_back_quantity[]" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')"></td>

											<td><input style="width: 35%;" type="text" id="unit_price_free" value="{{ old('unit_price_free', $value->unit_price_free) }}" name="unit_price_free[]" oninput="checkQuantity(this)" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')"></td>

											<td><input style="width: 35%;" type="text" id="unit_price_chargeable" value="{{ old('unit_price_chargeable', $value->unit_price_chargeable) }}" name="unit_price_chargeable[]" oninput="checkQuantity(this)" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')"></td>

											<td>
												<input type="checkbox" id="labour_freeb1{{ $i }}" name="labour_free[]" value="0" onchange="checkOnluOne(this)" @if($value->labour_free == 0) @php echo "checked" @endphp @endif>
												<label for="labour_freeb1{{ $i }}">Free</label>
											{{-- </td>

												<td> --}}
													<input type="checkbox" id="labour_freeb2{{ $i }}" name="labour_free[]" value="1" onchange="checkOnluOne(this)" @if($value->labour_free == 1) @php echo "checked" @endphp @endif>
													<label for="labour_freeb2{{ $i }}">Chargeable</label>
												</td>
											</tr>
											@php unset($dsr->dsr_transaction[$key]); $i++; @endphp
							...
							<div class="row" id="maintenance_type_detail_amc">
									...
									<div class="form-group form-float">
										<div class="form-line">
											<select class="form-control" name="complaint_id_amc" id="complaint_id_amc" disabled>
												<option value="">-- Please select complaints --</option>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control datepicker" name="call_receive_date_amc" id="call_receive_date_amc" placeholder="Call receive date eg,(dd-mm-yyyy)" value="{{ old('call_receive_date_amc', date('d-m-Y', strtotime($dsr->call_receive_date))) }}" data-zdp_readonly_element="false">
											<label class="form-label">Call receive date</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="nature_of_complaint_by_customer_amc" id="nature_of_complaint_by_customer_amc" value="{{ old('nature_of_complaint_by_customer_amc', $dsr->nature_of_complaint_by_customer) }}">
											<label class="form-label">Nature of complaint(By customer)</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="fault_observation_by_engineer_amc" id="fault_observation_by_engineer_amc" value="{{ old('fault_observation_by_engineer_amc', $dsr->fault_observation_by_engineer) }}">
											<label class="form-label">Fault observed(By engineer)</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="action_taken_by_engineer_amc" id="action_taken_by_engineer_amc" value="{{ old('action_taken_by_engineer_amc',$dsr->action_taken_by_engineer) }}">
											<label class="form-label">Action taken & result(By engineer)</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-group form-float">
										<div class="form-line">
											<textarea class="form-control" name="remarks_amc" id="remarks_amc">{{ old('remarks_amc',$dsr->remarks) }}</textarea>
											<label class="form-label">Remarks if any</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group form-float">
										<div class="form-line">
											<select class="form-control" name="product_id_amc" id="product_id_preventive" required>
												...
												@foreach ($amc_products as $amc_product)
								                    @if($amc_product->product_id==old('product_id_amc',$dsr->product_id))
								                    	<option value="{{ $amc_product->product_id }}" {{ (old('product_id_amc',$dsr->product_id) == $amc_product->product_id) ? 'selected' : '' }}>{{ ucwords($amc_product->product->name) }}</option>
								                    @endif
							                    @endforeach
											@endif
											</select>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="model_no_amc" id="model_no_amc" value="{{ old('model_no_amc',$dsr->model_no) }}">
											<label class="form-label">Product model no</label>
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="serial_no_amc" id="serial_no_amc" value="{{ old('serial_no_amc',$dsr->serial_no) }}">
											<label class="form-label">Product serial no</label>
										</div>
									</div>
								</div>

								<div class="col-md-12" id="spare_part_amc_auto_hide">
									<table class="table table-bordered">
										<thead>
											<tr>
												<th colspan="4">PARTS SUPPLIED /REPLACE</th>
									...
									@if($dsr_transaction1->count())
											
										@foreach($dsr_transaction1 as $key => $value)
											<tr>
												<td>{{ $key+1 }}</td>
												<td>
													<div class="form-group form-float">
														<div class="form-line">
															<select class="form-control sp_check_duplicate spare_part_id" id="spare_part_id" name="spare_part_id_amc[]" onchange="isDuplicateAlReadySelected(this)">
																...
																<option value="{{ $assigned_spare_part->spare_part->id }}" data-themeid="{{ $assigned_spare_part->spare_part->id }}" {{ old('spare_part_id_amc',$value->spare_part_id) == $assigned_spare_part->spare_part->id ? 'selected' : '' }}>{{ ucwords($assigned_spare_part->spare_part->part_no) }}</option>
												...
												<td>
													<input type="text" id="spare_part_description" name="spare_part_description_amc[]" value="{{ old('spare_part_description_amc',$value->spare_part->name) }}"> 
												</td>

												<td>
													<input style="width: 35%;" type="text" id="spare_part_quantity" name="spare_part_quantity_amc[]" oninput="checkQuantity(this)" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" value="{{ old('spare_part_quantity_amc',$value->spare_part_quantity) }}">
												</td>

												<td>
													<input type="checkbox" id="basic_checkbox_1{{ $i }}" name="spare_part_taken_back_amc[]" value="1" onchange="checkOnluOne(this)" @if($value->spare_part_taken_back == 1) @php echo "checked" @endphp @endif>
													<label for="basic_checkbox_1{{ $key }}">yes</label>

													<input type="checkbox" id="basic_checkbox_2{{ $i }}" name="spare_part_taken_back_amc[]" value="0" onchange="checkOnluOne(this)" @if($value->spare_part_taken_back == 0) @php echo "checked" @endphp @endif>
													<label for="basic_checkbox_2{{ $key }}">no</label>

												</td>

												<td><input style="width: 35%;" type="text" name="spare_part_taken_back_quantity_amc[]" value="{{ old('spare_part_taken_back_quantity_amc', $value->spare_part_taken_back_quantity) }}" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')">
												</td>

												<td>
													<input style="width: 35%;" type="text" id="unit_price_free" name="unit_price_free_amc[]" oninput="checkQuantity(this)" value="{{ old('unit_price_free_amc',$value->unit_price_free) }}" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')">
												</td>

												<td>
													<input style="width: 35%;" type="text" id="unit_price_chargeable" name="unit_price_chargeable_amc[]" oninput="checkQuantity(this)" value="{{ old('unit_price_chargeable_amc',$value->unit_price_chargeable) }}" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')">
												</td>

												<td>
													<input type="checkbox" id="labour_free1{{ $i }}" name="labour_free_amc[]" value="{{ old('labour_free_amc',$value->labour_free) }}" onchange="checkOnluOne(this)" @if($value->labour_free == 0) @php echo "checked" @endphp @endif >
													<label for="labour_free1{{ $i }}">Free</label>
												

													<input type="checkbox" id="labour_free2{{ $i }}" name="labour_free_amc[]" value="{{ old('labour_free_amc',$value->labour_free) }}" onchange="checkOnluOne(this)" @if($value->labour_free == 1) @php echo "checked" @endphp @endif>
														<label for="labour_free2{{ $i }}">Chargeable</label>
													</td>

												</tr>

												@php unset($dsr_transaction1[$key]); $i++; @endphp
...
<script>
	...
	<?php if($dsr->client->branch_name!=""){?>
		$(document).ready(function(){
			$('.auto_hide').show();
		});
		<?php } ?>

		<?php if($dsr->maintenance_type=='1'){?>
			$(document).ready(function(){
				...
				$('#spare_part_complaint_auto_hide').show(function(){
						$(this).find("input, select, textarea").prop("disabled", false);
				});

				$('#spare_part_amc_auto_hide').hide(function(){
					$(this).find("input, select, textarea").prop("disabled", true);
				});
			});
			<?php } ?>
			<?php if($dsr->maintenance_type=='2'){?>
				$(document).ready(function(){
					...
					$('#spare_part_amc_auto_hide').show(function(){
						$(this).find("input, select, textarea").prop("disabled", false);
					});

					$('#spare_part_complaint_auto_hide').hide(function(){
						$(this).find("input, select, textarea").prop("disabled", true);
					});
				});
				<?php } ?>
		...
		success: function(response) {
			...
			if(response) {   
				...
				$('#product_id_preventive').html(toAppendProductAmc);
					...
					$('#maintenance_type_detail_complaint').hide();
					$('#maintenance_type_detail_amc').hide();
					$('#spare_part_complaint_auto_hide').hide();
					$('#spare_part_amc_auto_hide').hide();
	...
	$.ajax({
		...
		success: function(response) {
			...
			if(response) {
				...
				toAppend +='<tr><th>Contact Person name</th><th>Contact Person phone no</th></tr>';
