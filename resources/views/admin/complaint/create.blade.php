                    ...
                    <form id="form_validation" method="POST" action="{{ route('add-new-complaint.post') }}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="client_id" id="client_id" required>
                                            ...
                                            <option value="{{ $client->name }}" data-themeid="{{ $client->name }}"
                                                {{ old('client_id') == "$client->name" ? 'selected' : '' }}>
                                ...
                                <div class="body table-responsive">
                                    <table class="table" id="contact_person_details">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <input type="radio" name="contact_person_details"
                                                        id="contact_person_1" class="with-gap contact_person_details"
                                                        value="1"
                                                        @if (old('contact_person_details') == '1') {{ 'checked' }} @endif><label
                                                        for="contact_person_1"><input type="text" class="form-control"
                                                            name="contact_person_name"
                                                            value="{{ old('contact_person_name') }}"
                                                            placeholder="Contact person1 name"></label>
                                                </th>
                                                <td>
                                                    <input type="text" class="form-control" name="c_p_1_email"
                                                        value="{{ old('c_p_1_email') }}"
                                                        placeholder="Contact person1 email">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="c_p_1_ph_no"
                                                        value="{{ old('c_p_1_ph_no') }}" maxlength="10"
                                                        placeholder="Contact person1 ph no">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <input type="radio" name="contact_person_details"
                                                        id="contact_person_2" class="with-gap contact_person_details"
                                                        value="2"
                                                        @if (old('contact_person_details') == '2') {{ 'checked' }} @endif><label
                                                        for="contact_person_2"><input type="text" class="form-control"
                                                            name="c_p_2_name" value="{{ old('c_p_2_name') }}"
                                                            placeholder="Contact person2 name"></label>
                                                </th>
                                                <td>
                                                    <input type="text" class="form-control" name="c_p_2_email"
                                                        value="{{ old('c_p_2_email') }}"
                                                        placeholder="Contact person2 email">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="c_p_2_ph_no"
                                                        value="{{ old('c_p_2_ph_no') }}" maxlength="10"
                                                        placeholder="Contact person2 ph no">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control datepicker" name="complaint_call_date"
                                            placeholder="Complaint call date eg,(dd-mm-yyyy)"
                                            data-zdp_readonly_element="false" value="{{ old('complaint_call_date') }}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="group_id" id="group_id" required>
                                            ...
                                            <option value="{{ $group->id }}" data-themeid="{{ $group->id }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select class="form-control show-tick" name="complaint_master_id"
                                            id="complaint_master_id" required>
                                            <option value=""> Please select a complaint </option>
                                            @foreach ($c_masters as $c_master)
                                                @if ($c_master->id == old('complaint_master_id'))
                                                    <option value="{{ $c_master->id }}"
                                                        {{ old('complaint_master_id') == $c_master->id ? 'selected' : '' }}>
                                                        {{ ucwords($c_master->complaint_details) }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6" id="nt_in_list_hide">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="not_in_the_list_detail"
                                            value="{{ old('not_in_the_list_detail') }}">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    <input type="radio" name="product_id"
                                                                        id="product_id{{ $product_detail->id }}"
                                                                        class="with-gap"
                                                                        value="{{ old('product_id', $product_detail->id) }}"
                                                                        @if (old('product_id') == $product_detail->id) {{ 'checked' }} @endif
                                                                        required><label
                                                                        for="product_id{{ $product_detail->id }}">{{ $product_detail->name }}</label>
                                                                </div>
                                                            </div>
                                                        </th>
...
@section('scripts')
    ...
    <script>
        ...
        $("#client_id").change(function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('get-all-branch-details-new.ajax') }}",
                data: {
                    'client_id': client_id
                },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response) {
                        var toAppend = '';
                        toAppend +=
                            '<tr><th>Contact Person name</th><th>Contact Person email</th><th>Contact Person phone no</th></tr>';
                        $.each(response, function(i, o) {
                            contact_person_name = '';
                            ...
                            toAppend +=
                                '<tr><th scope="row"><input type="radio" name="contact_person_details" id="contact_person_1" class="with-gap" value="1"><label for="contact_person_1"><input type="text" class="form-control" name="contact_person_name" value="' +
                                contact_person_name +
                                '" placeholder="contact person1 name"></label></th><td><input type="text" class="form-control" name="c_p_1_email" value="' +
                                c_p_1_email +
                                '" placeholder="contact person1 email"></td><td><input type="text" class="form-control" name="c_p_1_ph_no" value="' +
                                c_p_1_ph_no +
                                '" placeholder="contact person1 ph_no" maxlength="10"></td></tr><tr><th scope="row"><input type="radio" name="contact_person_details" id="contact_person_2" class="with-gap" value="2"><label for="contact_person_2"><input type="text" class="form-control" name="c_p_2_name" value="' +
                                c_p_2_name +
                                '" placeholder="contact person2 name"></label></th><td><input type="text" class="form-control" name="c_p_2_email" value="' +
                                c_p_2_email +
                                '" placeholder="contact person2 email"></td><td><input type="text" class="form-control" name="c_p_2_ph_no" placeholder="contact person2 ph_no" maxlength="10" value="' +
                                c_p_2_ph_no + '"></td></tr>';
                        });
                    ...
                    if (response) {
                        ...
                        if (response.complaint_master_details.length) {
                            ...
                            $.each(response.complaint_master_details, function(i, o) {
                                ...
                                toAppend += '<option value="' + o.id + '" data-themeid="' + o
                                    .id + '">' + o.complaint_details + '</option>';
                            });
                        ...
                        if (!response.product_details.length) {
                            ...
                            toAppendProduct +=
                                '<tr id="head_hide"><th>Product name</th><th>Code</th><th>Model no</th><th>Serial no</th><th>Brand</th><th>Equipment no</th><th>Date of install</th></tr>';
                            $.each(response.product_details, function(i, o) {
                                ...
                                toAppendProduct +=
                                    '<tr><th scope="row"><div class="form-group"><div class="form-line"><input type="radio" name="product_id" id="product_id' +
                                    o.id + '" class="with-gap" value="' + o.id +
                                    '"><label for="product_id' + o.id + '">' + o.name +
                                    '</label></div></div></th><td>' + code + '</td><td>' + o
                                    .model_no + '</td><td>' + o.serial_no + '</td><td>' + o
                                    .brand + '</td><td>' + equipment_no + '</td><td>' +
                                    date_of_install + '</td></tr>';
                            });
