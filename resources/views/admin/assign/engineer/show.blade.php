                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ucwords($assign_eng_name->user->first_name . ' ' . $assign_eng_name->user->middle_name . ' ' . $assign_eng_name->user->last_name) }}
                                    </td>
                                ...
                                @foreach ($assign_eng as $assign_engineer)
                                    <tr>
                                        ...
                                        <td>
                                            <span data-toggle="popover" title="{{ $assign_engineer->client->name }} Detail"
                                                data-content= "Zone : {{ ucwords($assign_engineer->client->zone->name) }} <br> Email : {{ $assign_engineer->client->email }} <br> Ph no : {{ $assign_engineer->client->ph_no }} <br>  Address : {{ $assign_engineer->client->address }} <br> Remarks : {{ $assign_engineer->client->remarks }}">{{ $assign_engineer->client->name }}</span>
                                        </td>
                                                    ...
                                                    @foreach ($assign_engineer->client->assigned_products as $key => $assgn_p)
                                                        <tr>
                                                            ...
                                                            <td><span data-toggle="popover"
                                                                    title="{{ $assgn_p->product->name }} Detail"
                                                                    data-content= "Code : {{ $assgn_p->product->product_code }} <br> Model no : {{ $assgn_p->product->model_no }} <br> Brand : {{ $assgn_p->product->brand }} <br>  Company : {{ $assgn_p->product->company_name }}">
                                                                    {{ $assgn_p->product->name }} </span></td>
