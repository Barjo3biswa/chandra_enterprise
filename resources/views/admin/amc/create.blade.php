				...
				<form id="form_validation" method="POST" action="{{ route('add-new-client-amc.store') }}">
							...
							<div class="form-group form-float">
								<div class="form-line">
									<select class="form-control show-tick" name="zone_id" id="zone_id" required>
										...
										<option value="{{ $zones->id }}" data-themeid="{{ $zones->id }}" {{ old('zone_id') == "$zones->id" ? 'selected' : '' }}>{{ ucwords($zones->name) }}</option>
										<?php endforeach; ?>
									</select>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control datepicker_month_only" id="amc_start_date" name="amc_start_date" placeholder="eg,(dd-mm-yyyy)" data-zdp_readonly_element="false" value="{{ old('amc_start_date') }}" autocomplete="off" required="required">
						...
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control" id="amc_demand" name="amc_demand" placeholder="AMC bill amount" value="{{ old('amc_demand') }}" min="0" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" maxlength="10" autocomplete="off" required="required">
...
html +='<div class="form-group form-float">';
html +='<div class="form-line">';
html +='<input type="text" class="form-control" name="amc_demand_collected[]" placeholder="Collected amount">';
html +='</div>';
html +='</div>';
