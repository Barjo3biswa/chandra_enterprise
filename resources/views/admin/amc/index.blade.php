        ...
        <div class="card">
            <div class="header">
                ...
                <ul class="header-dropdown m-r--5">
                    ...
                    <li><button type="button" class="btn bg-brown waves-effect" onclick="ExportExcelModal(this)"> <i class="fa fa-download" aria-hidden="true"></i> Export to Excel </button></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(Auth::user()->can('edit client amc'))
                                		<a href="{{ route('edit-client-amc',Crypt::encrypt($client_amc->id)) }}" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                    @endif
                                    
                                		
                                    <a href="{{ route('show-client-amc',Crypt::encrypt($client_amc->id)) }}" class="btn btn-sm btn-info" data-toggle="tooltip" title="Details"><i class="fa fa-eye"></i></a>
                                    
                                    @if(Auth::user()->can('assign amc to engineer'))
                                    <a href="{{ route('amc-assigned-to-engineers',Crypt::encrypt($client_amc->id)) }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Assign to engineer"><i class="fa fa-user"></i></a>
                                    @endif

                                		@if(Auth::user()->can('delete client amc'))
                                    <a href="{{ route('destroy-client-amc',Crypt::encrypt($client_amc->id)) }}" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure')"><i class="fa fa-trash"></i></a>
                                    @endif

                                    @if(Auth::user()->can('add raise-bill'))
                                    <a href="{{ route('raise-bill-client-amc',Crypt::encrypt($client_amc->id)) }}" class="btn btn-sm bg-teal" data-toggle="tooltip" title="Raise bill"><i class="fa fa-rupee"></i></a>
                                    @endif
        ...
        <div class="containier">
          <div class="row">
              ...
              <div class="form-group form-float">
                 <div class="form-line">
                    <select class="form-control show-tick" name="zone_id" id="zone_id">
                        ...
                        <option value="{{ $id }}" {{ old('zone_id') == "$zone" ? 'selected' : '' }}>{{ ucwords($zone) }}</option>
                        <?php endforeach; ?>
                    </select>
              ...
              <div class="form-group form-float">
                 <div class="form-line">
                    <select class="form-control show-tick" name="client_id" id="client_id">
                        ...
                        <option value="{{ $c_grp_by->name }}" {{ old('client_id') == "$c_grp_by->name" ? 'selected' : '' }}>{{ ucwords($c_grp_by->name) }}</option>
                        <?php endforeach; ?>
                    </select>
           ...
           {{--  <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" list="options_fin_yr" class="form-control" name="financial_year" id="financial_year" value="{{ old('financial_year') }}" autocomplete="off" placeholder="eg, yyyy-yy">
          ...
          <div class="row">
               ...
               <div class="form-group form-float">
                 <div class="form-line">
                    <select class="form-control show-tick" name="roster_id" id="roster_id">
                        ...
                        <option value="{{ $roster->id }}" data-themeid="{{ $roster->id }}" {{ old('roster_id') == "$roster->id" ? 'selected' : '' }}>{{ ucwords($roster->roster_name) }}</option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group form-float">
                <div class="form-line">
                  <input type="text" class="form-control datepicker" id="amc_start_date" name="amc_start_date" placeholder="AMC start date eg,(dd-mm-yyyy)" data-zdp_readonly_element="false" value="{{ old('amc_start_date') }}" autocomplete="off">
            ...
            <div class="col-md-4">
                <div class="form-group form-float">
                <div class="form-line">
                  <input type="text" class="form-control datepicker" id="amc_end_date" name="amc_end_date" placeholder="AMC end date eg,(dd-mm-yyyy)" data-zdp_readonly_element="false" value="{{ old('amc_end_date') }}" autocomplete="off">
