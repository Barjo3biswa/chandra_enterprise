...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form id="form_validation" method="POST" action="{{ route('update-client-outstanding-bill',Crypt::encrypt($client_bill->id)) }}">
							...
							<div class="form-group form-float">
								<div class="form-line">
									 <select class="form-control show-tick" name="client_id" id="client_id" required>
					                    ...
					                    <option value="{{ $client->name }}" data-themeid="{{ $client->name }}" {{ old('client_id',$client_bill->client->name) == $client->name ? 'selected' : '' }}>{{ ucwords($client->name) }}</option>
					                    <?php endforeach; ?>
		                            </select>
							...
							<div class="form-group form-float">
								<div class="form-line">
									 <select class="form-control show-tick" name="branch" id="branch" required>
				                        ...
				                        @if($client->branch_name==old('branch',$client_bill->client->branch_name))
				                          <option value="{{ $client->branch_name }}" {{ (old('branch',$client_bill->client->branch_name) == $client->branch_name) ? 'selected' : '' }}>{{ ucwords($client->branch_name) }}</option>
				                        @endif
				                      @endforeach
		                            </select>
							...
							<div class="form-group form-float">
								<div class="form-line">
									 <select class="form-control show-tick" name="company_id" required>
					                    ...
					                    <option value="{{ $company->id }}" {{ old('company_id',$client_bill->company_id) == "$company->id" ? 'selected' : '' }}>{{ ucwords($company->name) }}</option>
					                    <?php endforeach; ?>
		                            </select>
							...
							<div class="form-group form-float">
								<div class="form-line">
									 <select class="form-control show-tick" name="group_id" required>
					                    ...
					                    <option value="{{ $group->id }}" {{ old('group_id',$client_bill->group_id) == "$group->id" ? 'selected' : '' }}>{{ ucwords($group->name) }}</option>
					                    <?php endforeach; ?>
		                            </select>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control" name="bill_no" value="{{ old('bill_no',$client_bill->bill_no) }}" required>
						...
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control datepicker" name="bill_date" value="{{ old('bill_date',$client_bill->bill_date) }}" required>
						...
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control" name="bill_amount" value="{{ old('bill_amount',$client_bill->bill_amount) }}" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" required>
						...
						<div class="col-md-3">
							<div class="form-group form-float">
								<div class="form-line">
									<input type="text" class="form-control datepicker" name="pay_by_date" value="{{ old('pay_by_date',$client_bill->pay_by_date) }}" required>
 				...
 				<div id="main_sp_parent">
 					{{-- <div class="sub_sp_child"> --}}
 					@foreach($client_bill_transactions as $key =>  $bill_trans)
 					<div class="row sub_sp_child">

 						<div class="col-md-3">
 							<div class="form-group form-float">
 								<div class="form-line">
 									<input type="text" class="form-control" name="product_name[]" value="{{ old('product_name',$bill_trans->product_name) }}" required>
 						...
 						<div class="col-md-3">
 							<div class="form-group form-float">
 								<div class="form-line">
 									<input type="text" class="form-control" name="product_quantity[]" value="{{ old('product_quantity',$bill_trans->product_quantity) }}" required>
 						...
 						<div class="col-md-3">
 							<div class="form-group form-float">
 								<div class="form-line">
 									<input type="text" class="form-control" name="product_price[]" value="{{ old('product_price',$bill_trans->product_price) }}" required>
...
$('.datepicker').Zebra_DatePicker({
 ...
 $(document).on('click', '.remove_ap', function() {
 	if ($(document).find('.sub_sp_child').length==1)
 	{
 		alert('Atleast one product in the outstanding bill');
 		return false;
 	}
