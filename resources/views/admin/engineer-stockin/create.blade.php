...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Issue Stock Form <small>Issue stock-ins</small>
                </h2>
            ...
            <div class="body">
                ...
                <form action="{{ route('add-new-engineer-issue-stockin.post') }}" method="post" id="form_validation" class="spForm">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="engineer_id" id="engineer_id" required>
                                        ...
                                        <option value="{{ $engineer->id }}" {{ old('engineer_id') == "$engineer->id" ? 'selected' : '' }}>{{ ucwords($engineer->first_name.' '.$engineer->middle_name.' '.$engineer->last_name.' '.'('.$engineer->role.')') }}</option>
                                        <?php endforeach; ?>
                                    </select>
                ...
                <div id="main_sp_parent">
                    ...
                    <div class="row" id="sub_sp_parent">
                       ...
                       <div class="col-md-3">
                            <div class="form-group form-float">
                                <div class="form-line">
                                   <input type="text" class="form-control" name="issue_quantity[]" min="0" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" maxlength="3" value="{{ old('issue_quantity') }}" required="required">
